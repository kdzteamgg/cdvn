...
local function CreateWindow(title)
    ...
    mainFrame.Size = UDim2.new(0, 350, 0, 230) -- Changed from 300x200 to 350x230
    mainFrame.Position = UDim2.new(0.5, -175, 0.5, -115) -- Adjusted position for new size
    ...
    local openTween = CreateTween(mainFrame, {Size = UDim2.new(0, 350, 0, 230), Position = UDim2.new(0.5, -175, 0.5, -115)}, 0.5)
    openTween:Play()
